...
function eventListeners() {
    //evento para el ingreso de presupuesto
    document.addEventListener('DOMContentLoaded', preguntarPresupuesto);
    //evento para añadir gastos
    formulario.addEventListener('submit', agregarGasto);
    //evento para eliminar un  gasto y restaurar el presupuesto
    gastosListado.addEventListener('click', eliminarGasto);

}

//clases donde el presupuesto almacena informacion
class Presupuesto{
...
//clase para mostrar informacion en pantalla
class UI {
...
function preguntarPresupuesto() {
    ...
    //mostrar la informacion en el listado a partir de lo ingresado x el usuario
